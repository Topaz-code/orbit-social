          ...
          <div className="relative">
            {ownGroup ? (
              ...
              <div
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full bg-[#202A2D] border-2 border-dashed border-[#496D6B] hover:bg-[#2B3940] transition-all"
              >
                <Plus className="h-6 w-6 text-[#D0A56A] group-hover:scale-110 transition-transform" />
              </div>
            )}
            <button
              type="button"
              ...
              className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#D0A56A] text-[#171A1C] ring-2 ring-[#171A1C] shadow-xs"
              title="Add story"
            >
              <Plus className="h-3.5 w-3.5 stroke-[3]" />
            </button>
          </div>
          <span className="text-[11px] font-medium text-[#D9D0B8] max-w-[64px] truncate text-center">
