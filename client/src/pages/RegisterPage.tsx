    ...
    <div className="min-h-[100dvh] flex bg-[#171A1C] text-[#D9D0B8]">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#141819] border-r border-[#3A4B4D] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <svg
          ...
          aria-hidden="true"
        >
          <circle cx="55%" cy="48%" r="360" fill="none" stroke="#D0A56A" strokeWidth="1" />
          <circle cx="55%" cy="48%" r="260" fill="none" stroke="#496D6B" strokeWidth="0.8" />
          <circle cx="55%" cy="48%" r="165" fill="none" stroke="#71877B" strokeWidth="0.6" />
          <circle cx="55%" cy="48%" r="80"  fill="none" stroke="#D0A56A" strokeWidth="0.5" />
          <circle cx="55%" cy="12.5%" r="5" fill="#D0A56A" />
          <circle cx="81%" cy="48%" r="4.5" fill="#496D6B" />
          <circle cx="55%" cy="71%" r="4" fill="#71877B" />
          <circle cx="39%" cy="48%" r="3.5" fill="#D0A56A" />
          <line x1="55%" y1="48%" x2="55%" y2="12.5%" stroke="#496D6B" strokeWidth="0.4" strokeDasharray="4 8" />
          <line x1="55%" y1="48%" x2="81%" y2="48%" stroke="#496D6B" strokeWidth="0.4" strokeDasharray="4 8" />
          <line x1="55%" y1="48%" x2="55%" y2="71%" stroke="#496D6B" strokeWidth="0.4" strokeDasharray="4 8" />
          <line x1="55%" y1="48%" x2="39%" y2="48%" stroke="#496D6B" strokeWidth="0.4" strokeDasharray="4 8" />
          <circle cx="12%" cy="18%" r="1.5" fill="#D9D0B8" />
          <circle cx="82%" cy="10%" r="1"   fill="#D9D0B8" />
          <circle cx="22%" cy="78%" r="1.5" fill="#D0A56A" />
          <circle cx="78%" cy="82%" r="1"   fill="#71877B" />
          <circle cx="8%"  cy="62%" r="1"   fill="#D9D0B8" />
          <circle cx="90%" cy="40%" r="1.5" fill="#496D6B" />
          <circle cx="30%" cy="28%" r="1"   fill="#D9D0B8" />
          <circle cx="72%" cy="90%" r="1"   fill="#D0A56A" />
        </svg>
      ...
      <div className="flex-1 flex flex-col bg-[#171A1C]">
        ...
        <div className="flex justify-end p-4 sm:p-6">
          ...
          >
            ...
            <span className="font-bold text-[#D0A56A]">Log in →</span>
          </button>
        </div>
